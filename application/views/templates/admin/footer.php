  ...
  <div class="row align-items-center justify-content-lg-between">
    ...
    <div class="col-lg-6">
      <ul class="nav nav-footer justify-content-center justify-content-lg-end">
        <li class="nav-item">
          <a href="<?= base_url(); ?>" class="nav-link" target="_blank">Flower Shop</a>
        </li>
        <li class="nav-item">
          <a href="<?= base_url(); ?>" class="nav-link" target="_blank">About Us</a>
        </li>
        <li class="nav-item">
          <a href="<?= base_url(); ?>" class="nav-link" target="_blank">Blog</a>
        </li>
        <li class="nav-item">
          <a href="<?= base_url(); ?>" class="nav-link" target="_blank">Contact</a>
        </li>
      </ul>
    </div>
  </div>
