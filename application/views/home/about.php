<div class="hero-wrap hero-bread" style="background-image: url(http://localhost/flower/assets/img/banner-2.jpg);">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
        <div class="heading-section-bold mb-4 mt-md-5">
          <div class="ml-md-0">
            <h2 class="mb-4">Welcome to Flower Shop an eCommerce website</h2>
          </div>
        </div>
        <div class="pb-md-5">
